...
namespace MedAdvisor.API.Test
{
    ...
    public class MedicineIntegrationTest
    {
        ...
        public async Task Get_Medicine_With_User_Logged_In_Should_Returns_OK()
        {

            var TestClient = RunApplication();

            await AuthentiacteUser(TestClient);
            var response = await TestClient.GetAsync("http://localhost:5260/api/Medicine");
            response.StatusCode.Should().Be(HttpStatusCode.OK);

        }
        [TestMethod]
        [TestProperty("ExecutionOrder", "2")]
        public async Task Get_Medicine_With_Out_User_Logged_In_Should_Return_BadResult()
        {
            var TestClient = RunApplication();
        ...
        public async Task Get_Medicine_With_Wrong_JWT_Token_Should_Return_BadRequest()
        {
        ...
        public async Task Add_Medicine_WithOut_Login_Should_Return_BadRequest()
        {

            var TestClient = RunApplication();

            var response = await TestClient.PostAsJsonAsync("http://localhost:5260/api/Medicine", new MedicineData() { medicineId = 1 });
        ...
        public async Task Add_Medicine_With_Invalid_Token_Should_Return_BadRequest()
        {
        ...
        public async Task Add_Medicine_With_Invalid_medicineId_Should_Return_BadRequest()
        {
            ...
            await AuthentiacteUser(TestClient);
            var InvalidmedicineId = 99;
            var response = await TestClient.PostAsJsonAsync("http://localhost:5260/api/Medicine", new MedicineData() { medicineId = InvalidmedicineId });
        ...
        public async Task Delete_Medicine_With_Logged_In_User_Should_Return_NoContent()
        {
            var TestClient = RunApplication();

            await AuthentiacteUser(TestClient);

            var response = await TestClient.PostAsJsonAsync("http://localhost:5260/api/Medicine/delete", new MedicineDeleteData() { medicineId = new List<int>() { 5 } });
        ...
        [TestMethod]
        [TestProperty("ExecutionOrder", "8")]
        public async Task Delete_Medicine_With_Out_Logged_In_User_Should_Return_BadRequest()
        {
            var TestClient = RunApplication();
        ...
        [TestMethod]
        [TestProperty("ExecutionOrder", "8")]
        public async Task Delete_Medicine_With_Invalid_Token_Should_Return_BadRequest()
        {
            var TestClient = RunApplication();
